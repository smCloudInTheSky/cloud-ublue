...
dnf install -y https://github.com/ebkr/r2modmanPlus/releases/download/v3.2.19/r2modman-3.2.19.x86_64.rpm
dnf install -y https://github.com/devsy-org/devsy/releases/download/v1.17.1/Devsy_linux_x86_64.rpm
