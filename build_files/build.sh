...
dnf -y copr enable xanderlent/amd-npu-driver
dnf -y install lact libvirt-devel mangohud pipx keepassxc firefox git-lfs clustershell vmaf-models vmaf libvmaf-devel s-tui rasdaemon acpica-tools edid-decode telnet libreswan edk2-ovmf numactl-devel ntsync-autoload wine-ntsync mono-core xrt xdna-driver tcsh
